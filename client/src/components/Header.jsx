  ...
  return (
    ...
    >
        ...
        >
          ...
          <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto m-10 text-center'
          initial = {{opacity:0}}
          animate={{opacity:1}}
          ...
          >Turn text to <span className='text-blue-600'>image</span>, in seconds.</motion.h1>
            ...
            className='mt-2 text-neutral-600'>Generated images from imagify
            </motion.p>
